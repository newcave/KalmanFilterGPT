...
def app():
    ...
    time_end = st.slider("Time end (seconds)", min_value=1, max_value=20, value=10, step=1)

    dt = st.slider("Time step (seconds)", min_value=0.1, max_value=1.0, value=0.2, step=0.1)

    x_0 = st.slider("Initial Streamflow estimate", min_value=0.0, max_value=20.0, value=12.0, step=0.1)

    P_0 = st.slider("Initial error covariance estimate", min_value=0.0, max_value=20.0, value=6.0, step=0.1)
