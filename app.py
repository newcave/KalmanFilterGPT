...
#   st.beta_set_page_config(page_title="Kalman Filter", page_icon=":bar_chart:", layout="wide", initial_sidebar_state="expanded")
    ...
    x_0 = sidebar.slider("Initial Streamflow estimate", min_value=0.0, max_value=75.0, value=12.0, step=0.1)
    P_0 = sidebar.slider("Initial error covariance estimate", min_value=0.0, max_value=90.0, value=6.0, step=0.1)
